-- --------------------------------------------------------------------------------------
--	BASIC SUBCLASS SKILLS TRAINER - 600002
-- --------------------------------------------------------------------------------------
SET
@Entry 		:= 600002,
@Model 		:= 26571, -- The Black Knight
@Name 		:= "The Half-Pint Goliath",
@Title 		:= "Basic Subclass Skills Trainer",
@Icon 		:= "Speak",
@GossipMenu := 0,
@MinLevel 	:= 80,
@MaxLevel 	:= 80,
...
INSERT INTO `npc_text` (`ID`, `text0_0`) VALUES (@Entry, 'Greetings $N. I can teach you about basic skills to subclassing!!!');
